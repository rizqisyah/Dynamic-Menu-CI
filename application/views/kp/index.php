                ...
                <nav class="navbar navbar-full navbar-fixed-top">
                    ...
                    <div class="collapse navbar-toggleable-sm" id="tmNavbar">                            
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> 
                               <a href="file:///C:/Users/USER/Downloads/DKP%20PROV%20JATENG/login.html" class="nav-link external">Login Admin</a>
                               </li>
                        </ul>
                ...
                <div class="tm-intro">
                    ...
                    <section id="tm-section-1">                        
                        <div class="tm-container text-xs-center tm-section-1-inner">
                          <img src="jateng.jpg" width="300" height="300">
                          
                          <p class="tm-intro-text">DINAS KELAUTAN DAN PERIKANAN PROVINSI JAWA TENGAH</p>
                    ...
                    <div class="tm-container tm-container-wide">
                        <div class="tm-news-item">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-news-container">
                                <h2 class="tm-news-title dark-gray-text">BERITA</h2>
                                <p class="tm-news-text">Berita terbaru mengenai Dinas Kelautan dan Perikanan Provinsi Jawa Tengah</p>
                                <a href="http://dkp.jatengprov.go.id/index.php/berita" class="btn tm-light-blue-bordered-btn tm-news-link">Preview</a>
                            </div>
                        </div>
                        ...
                        <div class="tm-news-item">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-news-container flex-order-1">
                                <h2 class="tm-news-title dark-gray-text">ARTIKEL</h2>
                                <p class="tm-news-text">Artikel terbaru mengenai Dinas Kelautan dan Perikanan Provinsi Jawa Tengah</p>
                                <a href="http://dkp.jatengprov.go.id/index.php/artikel" class="btn tm-light-blue-bordered-btn tm-news-link">Detail</a>
                            </div>
                        </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <section id="tm-section-3" class="tm-section">
                    <div class="tm-container text-xs-center">
                      <h2 class="blue-text tm-title">GALERI</h2>
                      <p class="margin-b-5">Berisi dokumentasi kegiatan DKP PROV. JATENG</p>
                      <p>&nbsp;</p>
